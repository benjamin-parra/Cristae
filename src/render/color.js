...
// (mismo `HEX`): `#RGB` / `#RGBA` / `#RRGGBB` / `#RRGGBBAA`, con o sin `#`. El alpha SIEMPRE es el del
// parámetro (un `#RRGGBBAA` ignora su alpha propio: withAlpha existe para APLICAR este alpha). Lo que no
